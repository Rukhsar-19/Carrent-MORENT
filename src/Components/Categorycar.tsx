...
//                     <Link
//                       key={car.id}
//                       to={`/car/${car.car.toLowerCase()}-${car.car_model.toLowerCase()}`}
//                       style={{ textDecoration: "none", color: "inherit" }}
//                       className="col-lg-4"
//                     >
//                       <div className="detail-carrent">
...
//                               </h2>
//                               {/* <p className="detail-carname">{car.car_color}</p> */}
//                             </div>
//                             <i
//                               className={
//                                 car.availability
...
//                           {/* image placeholder (API doesn’t give image) */}
//                           <div className="carrentimg">
//                             <img
//                               src={`carrent1=${car.car}`}
//                               width={300}
//                               alt={car.car_model}
//                             />
//                           </div>
...
//                             <div className="logos-car">
//                               <i className="ri-gas-station-fill"></i>
//                               <p className="logos-desc">{car.car_model_year}</p>
//                             </div>
//                             <div className="logos-car">
//                               <i className="ri-loader-3-line"></i>
//                               <p className="logos-desc">Manual</p>
